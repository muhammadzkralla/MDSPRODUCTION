package com.dimits.mahalladeliveryserver.ui.order;
...
import com.dimits.mahalladeliveryserver.adapter.MyOrderAdapter;
import com.dimits.mahalladeliveryserver.adapter.MyShipperSelectionAdapter;
import com.dimits.mahalladeliveryserver.callback.IShipperLoadcallbackListener;
import com.dimits.mahalladeliveryserver.common.BottomSheetOrderFragment;
...
import com.dimits.mahalladeliveryserver.eventbus.LoadOrderEvent;
...
import com.dimits.mahalladeliveryserver.remote.IFCMServer;
import com.dimits.mahalladeliveryserver.remote.RetrofitFCMClient;
                                ...
                                .addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        if (dataSnapshot.exists()) {
                                            TokenModel tokenModel = dataSnapshot.getValue(TokenModel.class);
                                            Map<String, String> notiData = new HashMap<>();
                                            notiData.put(CommonAgr.NOTI_TITLE, "Your order was updated");
